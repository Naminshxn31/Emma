...
def get_provider(provider: str, voice: str, instructions: str, greeting: str | None = None) -> VoiceProvider:
    ...
    if provider == "gemini":
        ...
        return GeminiProvider(voice, instructions)
    if provider == "openai":
        from app.providers.openai_realtime import OpenAIProvider

        return OpenAIProvider(voice, instructions, greeting=greeting)
